...
public class GpsTask extends AsyncTask {
	...
	private fi.oulu.tol.esde11.smart.gps.GpsTaskCallBack callBk = null;
	...
	public GpsTask(Activity context, fi.oulu.tol.esde11.smart.gps.GpsTaskCallBack callBk) {
		this.callBk = callBk;
		this.context = context;
		gpsInit();
	}

	public GpsTask(Activity context, fi.oulu.tol.esde11.smart.gps.GpsTaskCallBack callBk, long time_out) {
		this.callBk = callBk;
		this.context = context;
